...
<p align="center">
  PurgaLib è una libreria/framework avanzato per SCP:SL che aggiunge funzionalità estese al server, gestione di ruoli personalizzati, eventi estesi e sistemi automatici come l’updater integrato.
</p>
...
PurgaLib fornisce:
<ul>
<li>Sistema di ruoli personalizzati e gestione dei permessi</li>
<li>Eventi estesi per giocatori, round, porte, ascensori, interazioni con Tesla, ecc.</li>
<li>API per integrazione con plugin</li>
<li>Updater automatico tramite GitHub Releases</li>
<li>Supporto per server multi-piattaforma (Windows/Linux)</li>
<li>Sistema di riconoscimento giocatori verificati e crediti automatici</li>
</ul>
</p>
